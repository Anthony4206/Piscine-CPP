...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/20 16:21:56 by alevasse          #+#    #+#             */
/*   Updated: 2023/02/20 16:22:39 by alevasse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(AForm const &rhs)
	: _name(rhs.getName()), _target(rhs.getTarget()), _signGrade(getSignGrade()), _execGrade(getExecGrade()) {
